    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                ...
                <button
                  onClick={() =>
                    copyToClipboard(success.patient_code, "patient_code")
                  }
                  style={{
                    padding: "8px 12px",
                    background: "#667eea",
            ...
            <div>
              ...
              >
                ...
                <button
                  onClick={() =>
                    copyToClipboard(success.access_code, "access_code")
                  }
                  style={{
                    padding: "8px 12px",
                    background: "#667eea",
          ...
          >
            <strong>⚠️ Important:</strong> Share the{" "}
            <strong>Patient Code</strong> and <strong>Access Code</strong> with
            the patient. They will need both to log in to the patient portal.
          </div>
